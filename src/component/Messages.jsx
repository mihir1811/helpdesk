        ...
        <div className="flex-grow h-full flex flex-col">
            <div className="w-full h-15 p-1 bg-[#ffce47] dark:bg-gray-800 shadow-md rounded-xl rounded-bl-none rounded-br-none">
                <div className="flex p-2 align-middle items-center">
                        {/* <div className="p-2 md:hidden rounded-full mr-1 hover:bg-[#ffce47] text-white">
                    ...
                    <div className="flex items-center">
                        <button type="button" class="me-3 focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">End Chat</button>
