...
const Messages = ({
  ...
  const chatData = useSelector((data) => data.chatInfo);
  const userInfo = useSelector((data) => data.userInfo);

  console.log(chatData, "argefdsx"  , userInfo);
  ...
  const handleSelect = (data) => {
    ...
    setSelectedSubcategory(data.subcategories);
  ...
  return (
    <div className="flex-grow h-full flex flex-col">
      ...
      <div className="w-full flex-grow bg-gray-100 dark:bg-gray-900 my-2 p-2 overflow-y-auto">
            ...
            return (
              <div key={index}>
                <div
                  ...
                  }  p-3 bg-[rgba(255,206,71,0.8)] bg-gray-800 hover:bg-white mx-3 my-1 rounded-2xl  w-max`}
                >
                  {data.category_name}
                </div>
              </div>
        ...
        {console.log(messages, "rhtergerd")}
            ...
            <>
              <div className="flex justify-end">
                <div className="flex items-end w-auto bg-[rgba(255,206,71,1)] dark:bg-gray-800 m-1 rounded-xl rounded-br-none sm:w-3/4 md:w-auto">
                  <div className="p-2">
                    <div className="text-black-200">{message.message}</div>
                  </div>
                </div>
              </div>
            </>
